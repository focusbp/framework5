<form>
	...
	<button type="button" class="ajax-link lang" invoke-function="edit_exe">Save</button>
	<button type="button" class="ajax-link lang" invoke-function="delete" data-id="{$post.id}" style="background:#860000;">Delete</button>
</form>
