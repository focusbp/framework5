<form id="wizard_chart_request_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">チャートで実現したい内容を入力してください。次へで Codex Terminal にプロンプトを投入します。</p>
	<table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:8px;">
		...
		<tr>
			<th style="text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">チャート種類</th>
			<td style="border:1px solid #d5dbe5;padding:8px;">{$chart_type_options[$row.chart_type]|escape}</td>
		</tr>
	</table>
	<p style="font-weight:bold;margin:0 0 4px 0;">集計に使うフィールド</p>
	...
	<p style="font-weight:bold;margin:0 0 4px 0;">Chart 制作内容 *</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_chart_fields" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_chart_request_next" data-form="wizard_chart_request_form" style="float:right;">次へ</button>
	</div>
</form>
