<form id="wizard_db_additionals_select_form">
	...
	<div style="line-height:1.9;">
		<label style="display:block;"><input type="radio" name="additional_type" value="original_form" {if $row.additional_type == 'original_form'}checked{/if}> {t key="wizard.db_additionals.type.original_form"}</label>
