<form id="wizard_pdf_request_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">PDFにしたい内容を入力してください。次へで Codex Terminal にプロンプトを投入します。</p>
	...
	<p style="font-weight:bold;margin:0 0 4px 0;">PDF制作内容 *</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_pdf_fields" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_pdf_request_next" data-form="wizard_pdf_request_form" style="float:right;">次へ</button>
	</div>
</form>
