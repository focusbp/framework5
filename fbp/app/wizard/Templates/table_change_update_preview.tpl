<form id="wizard_table_change_update_preview_form">
	<table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:10px;">
		<tr>
			...
			<td style="border:1px solid #d5dbe5;padding:8px;">項目の変更</td>
		</tr>
		<tr>
		...
		<tr>
			<th style="text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">変更項目</th>
			<td style="border:1px solid #d5dbe5;padding:8px;">{$row.fields_text|escape}</td>
		</tr>
		<tr>
			<th style="text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">変更内容</th>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_table_change_update_field" style="float:left;">前へ</button>
