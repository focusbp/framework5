<form id="wizard_csv_upload_table_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">CSV Uploadボタンを配置するテーブルを選択してください。</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		...
		<button type="button" class="ajax-link" invoke-function="submit_csv_upload_table_next" data-form="wizard_csv_upload_table_form" style="float:right;">次へ</button>
	</div>
</form>
