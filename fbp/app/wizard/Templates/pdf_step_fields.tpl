<form id="wizard_pdf_fields_form">
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_pdf_place" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_pdf_fields_next" data-form="wizard_pdf_fields_form" style="float:right;">次へ</button>
	</div>
</form>
