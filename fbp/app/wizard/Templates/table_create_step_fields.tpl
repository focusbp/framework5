<form id="wizard_step_fields_form" onsubmit="return false;">
	<p style="font-size:13px;color:#374151;margin:0 0 10px 0;">項目はCodexに自動提案させるか、手動で指定できます。手動設定では下の補助フォームから迷わず追記できます。</p>
	...
	<div id="wizard_manual_fields_wrap" {if $row.field_mode != "manual"}style="display:none;"{/if}>
		<div style="display:flex;align-items:flex-end;gap:8px;flex-wrap:wrap;padding:10px;border:1px solid #d5dbe5;background:#f8fafc;">
			<div style="flex:2 1 180px;">
				<p style="margin:0 0 4px 0;font-size:12px;">タイトル</p>
				<input type="text" id="wizard_manual_field_title" style="width:100%;" placeholder="例: ステータス">
			</div>
			<div style="flex:1 1 120px;">
				<p style="margin:0 0 4px 0;font-size:12px;">Type</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		...
		<button type="button" class="ajax-link" invoke-function="submit_fields_next" data-form="wizard_step_fields_form" style="float:right;">次へ</button>
	</div>
</form>
