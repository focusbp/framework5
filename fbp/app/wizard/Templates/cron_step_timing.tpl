<form id="wizard_cron_timing_form">
	...
	<input type="text" name="timing_text" value="{$row.timing_text|escape}" style="width:100%;">
	...
	<p style="font-weight:bold;margin:12px 0 4px 0;">{t key="wizard.cron.request.label"}</p>
