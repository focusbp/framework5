<form id="wizard_table_change_display_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">対象項目をどの画面に表示するか選択してください。</p>
	<input type="hidden" name="display_order" id="wizard_display_order" value="">
	<table style="width:100%;border-collapse:collapse;font-size:13px;">
		<thead>
			<tr>
				{if $is_screen_replace_mode}
					<th style="width:72px;text-align:center;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">順序</th>
				{/if}
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="{$back_function|escape}" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_table_change_display_next" data-form="wizard_table_change_display_form" style="float:right;">次へ</button>
	</div>
</form>
