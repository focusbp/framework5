<form id="wizard_cron_request_form">
	...
	<table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:8px;">
		<tr>
			<th style="width:180px;text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">{t key="wizard.cron.request.timing_label"}</th>
			<td style="border:1px solid #d5dbe5;padding:8px;">{$row.timing_text|escape}</td>
		</tr>
	</table>
	<p style="font-weight:bold;margin:0 0 4px 0;">{t key="wizard.cron.request.request_label"}</p>
