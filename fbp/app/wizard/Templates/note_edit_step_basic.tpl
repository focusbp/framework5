<form id="wizard_note_edit_basic_form" onsubmit="return false;">
	<p style="font-size:13px;color:#374151;margin:0 0 10px 0;">基本設定のみ変更します。高度な設定は後で別 wizard に分けます。</p>
	...
	<p style="font-weight:bold;margin:12px 0 4px 0;">説明</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_note_edit_table" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_note_edit_basic_next" data-form="wizard_note_edit_basic_form" style="float:right;">次へ</button>
	</div>
</form>
