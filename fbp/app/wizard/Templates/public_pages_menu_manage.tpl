<form id="wizard_public_pages_menu_manage_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">公開メニューに表示するページ、ラベル、並び順を管理してください。</p>
	...
	<table class="moredata" style="margin-top:0px;">
		<thead>
			<tr class="table-head">
				<th style="width:5%;"></th>
				<th style="width:27%;">ページタイトル</th>
				<th style="width:18%;">表示</th>
				<th style="width:50%;">メニューラベル</th>
			</tr>
		</thead>
	...
	<div style="margin-top:12px;overflow:auto;">
		...
		<button type="button" class="ajax-link" invoke-function="submit_public_pages_menu_manage_save" data-form="wizard_public_pages_menu_manage_form" style="float:right;">保存</button>
	</div>
</form>
