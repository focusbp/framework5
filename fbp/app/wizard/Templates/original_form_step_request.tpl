<form id="wizard_original_form_request_form">
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_original_form_place" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_original_form_request_next" data-form="wizard_original_form_request_form" style="float:right;">次へ</button>
	</div>
</form>
