<form id="wizard_csv_download_fields_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">使用するフィールドを選択してください（複数選択可）。</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_csv_download_place" style="float:left;">前へ</button>
		<button type="button" class="ajax-link" invoke-function="submit_csv_download_fields_next" data-form="wizard_csv_download_fields_form" style="float:right;">次へ</button>
	</div>
</form>
