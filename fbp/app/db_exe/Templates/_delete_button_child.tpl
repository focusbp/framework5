...
<button class="ajax-link lang" data-form="form_{$timestamp}" data-class="{$class}" data-function="delete_child_exe" data-db_id="{$db_id}" data-parent_id="{$parent_id}" style="background:#b11d1d;">Delete</button>
